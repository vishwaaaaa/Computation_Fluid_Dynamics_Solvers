function [node_loc, node_add, elem_rem] = curving_elements(in_gri, Q)
        ...
        if B2E(i, 3) ~= -1
            ...
            if curve_num == 1
                ...
                if Q == 2
                    ...
                    node_add(k, :) = [nodes(2), start_idx+1, nodes(3), start_idx+2, start_idx+3, nodes(1)];
                end
                ...
                if Q == 3
                    ...
                    node_add(k,:) = [nodes(2), start_idx+1, start_idx+2, nodes(3), start_idx+3, start_idx+4, start_idx+5, start_idx+6, start_idx+7, nodes(1)];
                end
            ...
            elseif curve_num == 2
                ...
                if Q == 2
                    ...
                    node_add(k, :) = [nodes(3), start_idx+1, nodes(1), start_idx+2, start_idx+3, nodes(2)];
                end
                ...
                if Q == 3
                    ...
                    node_add(k,:) = [nodes(3), start_idx+1, start_idx+2, nodes(1), start_idx+3, start_idx+4, start_idx+5, start_idx+6, start_idx+7, nodes(2)];
                end
                ...
                if Q == 2
                    ...
                    node_add(k, :) = [nodes(1), start_idx+1, nodes(2), start_idx+2, start_idx+3, nodes(3)];
                end
                ...
                if Q == 3
                    ...
                    node_add(k,:) = [nodes(1), start_idx+1, start_idx+2, nodes(2), start_idx+3, start_idx+4, start_idx+5, start_idx+6, start_idx+7, nodes(3)];
                end
